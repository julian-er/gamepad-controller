...
## Overview
This project is a TypeScript library for gamepad navigation and UI control. It is designed to be used as a dependency in your own web projects. The repository also includes a Vite-powered example/demo project in the `examples/` folder for live testing and experimentation.
